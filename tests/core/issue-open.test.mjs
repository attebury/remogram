...
describe('issue open core', () => {
  ...
  it('parseIssueOpenArgs caps body by default', () => {
    const longBody = 'z'.repeat(600);
    const parsed = parseIssueOpenArgs({ title: 'T', body: longBody });
    expect(Buffer.byteLength(parsed.body, 'utf8')).toBeLessThanOrEqual(512);
  });
