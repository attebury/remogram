...
describe('ref_compare payload compare fixtures', () => {
  ...
  it('records remogram packet size with local_git_only baseline', () => {
    ...
    const body = {
      ...
      compare_head_ref: 'feature/smoke-ref',
    ...
    const report = compareReport({
      command: 'ref_compare',
      providerId: 'github-api',
      baseRef: body.compare_base_ref,
      headRef: body.compare_head_ref,
    ...
    expect(report.compare_base_ref).toBe('main');
    expect(report.compare_head_ref).toBe('feature/smoke-ref');
