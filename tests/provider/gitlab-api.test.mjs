...
import * as gitlabProvider from '@remogram/provider-gitlab-api';
...
describe('provider-gitlab-api fixtures', () => {
  beforeEach(() => {
    ...
    vi.spyOn(gitlabBranchProtection, 'resolveBranchProtection').mockResolvedValue({
      branch_ref: 'main',
  ...
  it('listOpenPullsWithMeta number_asc full-collects when total exceeds retain_max', async () => {
    ...
    global.fetch.mockResolvedValueOnce(jsonResponse(allMrs.slice(3)));
