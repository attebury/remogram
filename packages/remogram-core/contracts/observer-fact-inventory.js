...
export const OBSERVER_REMOGRAM_COMMANDS = Object.freeze([
  ...
  { command: 'issue view', mcp_tool: 'issue_view', read_only: true, observer_proto: false },
  { command: 'issue inventory', mcp_tool: 'issue_inventory', read_only: true, observer_proto: false },
  { command: 'issue comments', mcp_tool: 'issue_comments', read_only: true, observer_proto: false },
...
export const OBSERVER_FACT_INVENTORY_PACKETS = Object.freeze([
  ...
  {
    packet_type: FACT_INVENTORY_PACKET_TYPES.ISSUE_INVENTORY_SLICE,
